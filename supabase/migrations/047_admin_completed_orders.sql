-- Add completed orders count to admin user stats.
-- Matches /admin/orders tab=completed: status=completed, non-trashed, non-archived.
...
BEGIN
  ...
  -- Completed tab: status=completed, exclude trashed and archived.
