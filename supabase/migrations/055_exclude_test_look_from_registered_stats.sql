-- Exclude technical @test.look auth accounts from registered_* counters.
-- Keeps get_admin_platform_stats body from 053; only registration COUNTs change.
-- Platform admins remain excluded. Real humans (non-test domains) are counted.
