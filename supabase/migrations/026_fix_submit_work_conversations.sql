-- submit_work (017/023) updated conversations.updated_at, but conversations only has last_message_at.
-- That caused RPC failure: column "updated_at" of relation "conversations" does not exist (42703).
