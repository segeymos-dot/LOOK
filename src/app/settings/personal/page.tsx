      ...
      <div className="space-y-4">
        {canSwitchUiMode && (
          <Card padding="md" className="space-y-2">
            <p className="text-sm font-medium text-text-primary">{t("uiMode.label")}</p>
            <p className="text-xs text-text-muted">{t("uiMode.hint")}</p>
            <UiModeSwitch />
          </Card>
        )}
        ...
        <Card padding="md" className="space-y-4">
          ...
          <div>
            ...
            <p className="rounded-xl border border-border-subtle bg-slate-50 px-3 py-2 text-sm text-text-secondary">
              {getRoleLabelT(displayProfile?.role, t)}
            </p>
